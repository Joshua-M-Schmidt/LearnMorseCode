...
public class SituationTrainingCourse extends CourseInfo {

    public SharedPreferences prefs;

    public SituationTrainingCourse(Context ctx){
        super(R.drawable.situation_course_1,0xff303030,"Situation\nTraining","situation_course_key",ctx,false);
